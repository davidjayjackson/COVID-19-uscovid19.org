...
### John Hopkins Daily Cases and Deaths
...
CASES$YMD <- seq(as.Date("2020-01-23"),as.Date("2020-10-29"),"day")
...
DEATHS$YMD <- seq(as.Date("2020-02-29"),as.Date("2020-10-29"),"day")
mean(CASES$CASES)
mean(DEATHS$DEATHS)
```
...
ggplot(AA) + geom_line(aes(x=Reported,y=EXP1,col="17")) +
