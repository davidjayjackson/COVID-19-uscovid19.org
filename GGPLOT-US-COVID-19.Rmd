...
mean(df1death$Death)
(410000 - 188900) / 117 # Jan 1, 2020
(410000 - 188900)/ 147 # Jan 31, 2020
...
p2 <-ggplot(df1death) +geom_line(aes(x=Reported,y=Deaths),lwd=2,col="blue") + 
  ...
  scale_y_continuous(labels = comma) +
   theme(axis.text.x=element_text(angle =- 45, vjust = 0.5)) +
  labs(title="US Daily Total Deaths(2020-03-01 - 2020-09-05)",x="Date Reported",y="Daily Deaths") +
  geom_hline(yintercept=943,col="red",lwd=2) +
