...
```{r}
(410000 - 192000) / 111 # Jan 1, 2021
```
#### Average Deaths/Day for Jan. 31, 2020

```{r}
(410000 - 187000)/ 141 # Jan 31, 2020
```
...
ggplot(df1death) +geom_line(aes(x=Reported,y=Deaths),lwd=2,col="blue") + 
  ...
  geom_hline(yintercept=980,col="red",lwd=2,col="Daily Avg") +
  geom_hline(yintercept=1963,col="green",lwd=2,col="Jan. 1") +
  geom_hline(yintercept=1412,col="black",lwd=2,col="Dec. 1")
```
