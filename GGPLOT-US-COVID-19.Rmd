...
ggplot(df1death) +geom_line(aes(x=Reported,y=Deaths),lwd=2,col="blue") + 
  ...
  labs(title="US Daily Total Deaths(2020-03-01 - 2020-09-08)",
       subtitle="Daily Avg (Black:966); Dec. 1 (Blue:1480);  Jan. 1 (Green:2126); Jan. 31 (Red:1623)"
       ,x="Date Reported",y="Daily Deaths") +
  geom_hline(yintercept=966,lwd=2,col="black") +
  geom_hline(yintercept=1480,lwd=1,col="blue") +
  geom_hline(yintercept=2126,lwd=1,col="green") +
   geom_hline(yintercept=1623,lwd=1,col="red")
```
