...
ggplot(df1death) +geom_line(aes(x=Reported,y=Deaths),lwd=2,col="blue") + 
  ...
  labs(title="US Daily Total Deaths(2020-03-01 - 2020-09-08)",
       subtitle="Daily Avg (Black:980); Dec. 1 (Blue:1412);  Jan. 1 (Green:1964); Jan. 31 (Red:1582)"
       ,x="Date Reported",y="Daily Deaths") +
  geom_hline(yintercept=980,lwd=2,col="black") +
  geom_hline(yintercept=1338,lwd=1,col="blue") +
  geom_hline(yintercept=1955,lwd=1,col="green") +
   geom_hline(yintercept=1528,lwd=1,col="red")
```
