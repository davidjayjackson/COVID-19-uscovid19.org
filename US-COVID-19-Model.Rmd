...
p1 <-ggplot(df1) +geom_line(aes(x=Reported,y=Cases,col="red"),lwd=1.5,col="red") + 
    scale_x_date(date_breaks = "1 month") +
  scale_y_continuous(labels = comma) +
   theme(axis.text.x=element_text(angle =- 45, vjust = 0.5)) +
...
ggplot(df1death) +geom_line(aes(x=Reported,y=Deaths),lwd=2,col="blue") + 
  ...
  scale_y_continuous(labels = comma) +
   theme(axis.text.x=element_text(angle =- 45, vjust = 0.5)) +
  labs(title="US Daily Total Deaths(2020-03-01 - 2020-10-09)",
       subtitle="Daily Avg (Red:950); Feb. 1 (Green:1320))"
       ,x="Date Reported",y="Daily Deaths") +
  geom_hline(yintercept=950,lwd=2,col="red") +
  geom_hline(yintercept=1320,lwd=1,col="green") 
