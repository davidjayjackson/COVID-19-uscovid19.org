...
* Revised US COVID19 Deaths: 385,611 vy Feb. 1, 2021 (Update October 22, 2020)
...
##
(385611 - sum(df1death$Deaths)) / 101 # Feb 1, 2021
...
ggplot(df1death) +geom_line(aes(x=Reported,y=Deaths),lwd=2,col="blue") + 
  ...
  labs(title="US Daily Total Deaths(2020-03-01 - 2020-10-17)",
       subtitle="Daily Avg (Red:937);Feb 1(Grenn: 1600/385611))"
       ,x="Date Reported",y="Daily Deaths") +
  geom_hline(yintercept=937,lwd=1.5,col="red") +
    geom_hline(yintercept=1600,lwd=1.5,col="green")
...
ggplot(df1death) +geom_smooth(aes(x=Reported,y=Deaths,col="Loess"),span=0.1) +
  ...
  labs(title="US Daily Total Deaths(2020-03-01 - 2020-10-17)",
       subtitle="Daily Avg (Red:942);Feb 1(Green: 1579/389087))"
       ,x="Date Reported",y="Daily Deaths") +
