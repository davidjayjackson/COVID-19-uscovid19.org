...
```
```{r}
ggplot(US) + geom_point(aes(x=Cases,y=Deaths)) +geom_smooth(aes(x=Cases,y=Deaths))
```
```{r}
ggplot(US) + geom_line(aes(x=Reported,y=Cases,col="Cases")) 
ggplot(US)  + geom_line(aes(x=Reported,y=Deaths,col="Deaths"))
```
