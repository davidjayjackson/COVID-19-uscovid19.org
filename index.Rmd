...
barplot(DRate ~Weekly,data=Weekly_Cases,main="Weekly Deaths Rates \n (max death rate = 9% week of Apr.4, 2020) ")
grid(col="black")

barplot(PredDeaths ~Weekly,data=Weekly_Cases,main="Estimated Weekly Deaths ")
grid(col="black")
```
...
barplot(PredDeaths ~Monthly,data=Monthly_Cases,main="Monthly Estimated Deaths")
grid(col="black")
```
